...
PROPRIETARY_BLENDS = DATA_DIR / "proprietary_blends.json"
...
CANONICAL_EQUIVALENCES = DATA_DIR / "canonical_equivalences.json"  # Reviewed exact-identity redirects across reference registries
...
EXCLUDED_NUTRITION_FACTS = {
    ...
    "polyunsaturated fatty acids", "monounsaturated fatty acids", "other fatty acids",
    "total carotenoids",
