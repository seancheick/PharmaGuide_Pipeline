...
| `st_johns_wort` | ingredient_quality_map | caution | established | May reduce some BP medication levels | St. John's Wort induces CYP3A4 and P-glycoprotein, reducing plasma levels of calcium channel blockers (nifedipine, amlodipine, verapamil) and potentially other antihypertensives. |
| `tribulus` | ingredient_quality_map | monitor | theoretical | Blood-pressure evidence is limited | Tribulus terrestris has diuretic and uricosuric properties and demonstrated antihypertensive effect in preclinical models (in combination with Zingiber officinale). Additive BP lo… |
| `yerba_mate` | ingredient_quality_map | caution | probable | Stimulant source — may raise BP | Yerba mate (Ilex paraguariensis) contains caffeine and theobromine, both xanthine stimulants with acute sympathomimetic effects on the cardiovascular system. Caffeine causes trans… |
| `yohimbe` | ingredient_quality_map | contraindicated | established | Not recommended with high blood pressure | Adrenergic stimulation may increase blood pressure and cardiovascular risk. |
