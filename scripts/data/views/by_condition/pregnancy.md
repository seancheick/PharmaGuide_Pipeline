...
| `butterbur` | ingredient_quality_map | contraindicated | probable | Liver-toxic alkaloid risk in pregnancy | Raw or non-PA-free butterbur (Petasites hybridus) contains pyrrolizidine alkaloids (senkirkine, senecionine) that are hepatotoxic and genotoxic — fetal exposure is unacceptable. M… |
...
| `wild_yam` | ingredient_quality_map | avoid | probable | Hormone-active — avoid in pregnancy | Wild yam (Dioscorea villosa) contains diosgenin, a steroidal sapogenin with documented estrogenic and phytoestrogenic activity in animal and in vitro models. Diosgenin has been sh… |
