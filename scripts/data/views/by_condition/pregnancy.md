...
| `feverfew` | ingredient_quality_map | contraindicated | established | Do not use during pregnancy | Tanacetum parthenium parthenolide inhibits platelet aggregation and has demonstrated uterotonic activity. Historical emmenagogue use is well-documented. It is not recommended duri… |
...
| `wild_yam` | ingredient_quality_map | avoid | theoretical | Hormone-active claims are uncertain | Wild yam (Dioscorea villosa) contains diosgenin, a steroidal sapogenin with documented estrogenic and phytoestrogenic activity in animal and in vitro models. Diosgenin has been sh… |
| `yohimbe` | ingredient_quality_map | contraindicated | probable | Stimulant — do not use in pregnancy | Yohimbe has stimulant and hemodynamic effects with concerning maternal-fetal risk profile. |
