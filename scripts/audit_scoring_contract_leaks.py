...
ALLOWLIST: dict[str, str] = {
    ...
    "scripts/scoring_v4/gate_safety.py|_dose_mg|get|quantity|437869d0a4ab": "pass_a_known_pending_native_evidence_contract",
    "scripts/scoring_v4/gate_safety.py|_dose_mg|get|unit_normalized|c7a08b90a025": "pass_a_known_pending_native_evidence_contract",
    "scripts/scoring_v4/gate_safety.py|_dose_mg|get|unit|d22733e3184e": "pass_a_known_pending_native_evidence_contract",
