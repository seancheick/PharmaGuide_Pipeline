...
FALSE_POSITIVE_TARGETS = {
    # The measured-intent router makes the explicit Omega-3 EPA/DHA identity
    # authoritative over four secondary vitamin rows. The critical guard is
    # unchanged: this must route to omega, never multi_or_prenatal.
