...
# The promoted release bundle, then the working build. Scratch /tmp builds are
# never read: they carried stale blobs from earlier sprints.
_BUILD_CANDIDATES = (catalog_dist_dir(), final_build_dir())
