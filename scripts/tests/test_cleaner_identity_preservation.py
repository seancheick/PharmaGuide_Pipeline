...
SOURCE_BOTANICAL_CASES = [
    ...
    ("Broccoli Sprout Extract",      "broccoli", "broccoli_sprout/broccoli botanical, not sulforaphane"),
    ("Broccoli sprout powder",       "broccoli", "broccoli_sprout/broccoli botanical, not sulforaphane"),
    ("Broccoli Sprout Extract standardized to 13% glucoraphanin", "broccoli", "standardized source extract remains broccoli_sprout identity"),
