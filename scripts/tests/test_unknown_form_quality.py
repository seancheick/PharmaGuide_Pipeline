...
def test_an_ineligible_form_never_sets_the_floor():
    ...
    # (CID 6057, (2S); parent UNII 42HK56048U Tyrosine). It stays a form so a
    # label disclosing it is scored and flagged, but it cannot define what an
    # undisclosed L-tyrosine is worth: that is N-acetyl L-tyrosine 8 - 1.
    tyrosine = IQM['l_tyrosine']
    assert tyrosine['forms']['d-tyrosine']['unknown_floor'] == {'eligible': False, 'reason': 'wrong_stereoisomer'}
