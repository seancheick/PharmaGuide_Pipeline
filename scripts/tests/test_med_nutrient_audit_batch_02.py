...
EXPECTED_STATUS = {
    ...
    # The final B1 sign-off found that the runtime class contains non-oral and
    # non-estrogen contraceptives. The estrogen-pill B6 evidence therefore
    # cannot publish through that overbroad class.
