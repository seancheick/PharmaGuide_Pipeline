...
SPECS: tuple[VocabSpec, ...] = (
    ...
    VocabSpec(
        ...
        total_entries=11,
        expected_ids=frozenset({"not_lawful_as_supplement", "adulterant", "banned_federal", "banned_state", "controlled_substance", "wada_prohibited", "restricted", "under_review", "high_risk", "contaminant_risk", "lawful"}),
        ...
        memberships=(MembershipSpec("banned_recalled_ingredients.json", "legal_status_enum", frozenset({"not_lawful_as_supplement", "adulterant", "banned_federal", "banned_state", "controlled_substance", "wada_prohibited", "restricted", "under_review", "high_risk", "contaminant_risk", "lawful"})),),
    ),
    VocabSpec(
