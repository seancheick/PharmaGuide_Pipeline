...
Automated test suite that validates the structural integrity of:
  ...
  2. Ingredient mapping data (IQM forms, clinical strains)

Invariants over the generated enriched/scored corpus live in
test_pipeline_data_flow_artifacts.py (generated-artifact tier).
