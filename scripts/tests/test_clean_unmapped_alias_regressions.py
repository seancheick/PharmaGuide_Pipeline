...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("Full Strength Pancreatin", "Pancreatin"),
        ...
        ("Gamma-Glutamylcysteines", "Gamma-Glutamylcysteines"),
        ("GKG", "gkg"),
        ("A-KIC", "a-kic"),
        ...
        ("Malate", "malate"),
        ("Lactococcus lactis strain plasma", "Lactococcus Lactis"),
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("Ajuga turkest Whole Herb Extract", "Ecdysterone"),
        ("Gynostemma Leaf, Stem Extract", "Gypenosides"),
        ("Coriolus versicolor Sporocarp Extract", "Turkey Tail"),
        ("Coriolus Versicolor Sporocarp Extract", "Turkey Tail"),
        ("Aloe vera Aerial Part Extract", "Aloe Vera"),
        ("Aloe vera Aerial Parts Extract", "Aloe Vera"),
