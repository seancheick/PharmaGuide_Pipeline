...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("Soynatto Fermented Soyfood", "soynatto"),
        ...
        ("Sirtmax", "Black Ginger"),
        ("Lactotripeptides", "lactotripeptides"),
        ("FRAC(R)", "frac(r)"),
        ("EP107", "ep107"),
        ("DNF-10 Yeast Hydrolysate", "dnf-10 yeast hydrolysate"),
        ...
        ("Micronized Purified Flavonoid Fraction", "micronized purified flavonoid fraction"),
        ...
        ("Horse Chestnut 20% extract", "Horse Chestnut"),
        ...
        ("Dihydroquercetin-3-Rhamnoside", "dihydroquercetin-3-rhamnoside"),
        ("ETAS", "etas"),
        ...
        ("Blackcurrant freeze-dried extract", "Blackcurrant"),
        ...
        ("Alpha-Glycosyl Isoquercitrin", "alpha-glycosyl isoquercitrin"),
        ("ActivAMP Gynostemma pentaphyllum Extract", "Gynostemma"),
        ("Actazin", "Kiwifruit"),
        ("AMP-XT", "amp-xt"),
        ("resVida", "Resveratrol"),
        ...
        ("heat-treated Lactobacillus plantarum L-137", "Chlorella"),
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("Lactobacillus gasseri CNCM I-5076", "Probiotics"),
        ("Pharma GABA", "GABA"),
    ],
)
