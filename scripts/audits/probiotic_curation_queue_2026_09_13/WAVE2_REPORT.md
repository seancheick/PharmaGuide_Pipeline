...
- Contexts with a machine-readable studied daily dose: 19; the rest are `unresolved` because the retrieved abstract did not state it or lost the exponent.
- Publication families: 57 (`trial_family`), so papers from one cohort cannot count twice.
- Primary-outcome directions: {'null': 6, 'positive': 6}; all-outcome directions: {'positive': 94, 'null': 41, 'mixed': 1, 'unresolved': 3}; outcome kinds: {'patient_important': 93, 'surrogate': 45, 'evidence_ranking': 1}.
