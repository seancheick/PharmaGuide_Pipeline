...
def main() -> int:
    ...
    lines = [
        ...
        "",
        f"Policy under review: `{POLICY}`. Representative per stratum is the first",
        ...
        f"| `positive_weak` | ceiling {round(ge.PRIMARY_FLOOR_MODERATE * ge.EFFECT_DIRECTION_MULTIPLIERS['positive_weak'], 4)} (MODERATE x multiplier) |",
        f"| `mixed` | ceiling {round(ge.PRIMARY_FLOOR_MODERATE * ge.EFFECT_DIRECTION_MULTIPLIERS['mixed'], 4)} (MODERATE x multiplier) |",
