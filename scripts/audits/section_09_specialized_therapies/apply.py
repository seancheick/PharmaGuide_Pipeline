...
SUPPRESSED = {
    "DEP_IMMUNOSUPPRESSANTS_MAGNESIUM": "Suppressed: current PMID is content-mismatched; calcineurin-specific magnesium evidence needs a verified replacement and narrow scope.",
    "DEP_IMMUNOSUPPRESSANTS_VITAMIND": "Suppressed: transplant-associated vitamin-D status does not establish a class-wide immunosuppressant depletion claim.",
    "DEP_HIVPI_VITAMIND": "Suppressed: current PMID is content-mismatched and the record conflates HIV disease with protease-inhibitor effects.",
    "DEP_HIVPI_ZINC": "Suppressed: current PMID is content-mismatched and the record conflates HIV disease with protease-inhibitor effects.",
}
NEUTRAL = {
    ...
    "alert_headline": "No medication-specific depletion alert", "alert_body": "This record does not establish a medication-caused nutrient depletion warning.",
    "acknowledgement_note": "No medication-specific nutrient coverage acknowledgement is emitted.",
    "monitoring_tip_short": "Follow the monitoring plan set by your treating clinician.", "food_sources_short": "Maintain dietary intake appropriate to your individual needs.",
}
def main() -> None:
