...
def explain_product(product: Dict[str, Any]) -> Dict[str, Any]:
    ...
    breakdown = shadow.get("v4_breakdown") if isinstance(shadow, dict) else {}
    ...
    return {
        ...
        "v4": {
            "score": shadow.get("raw_score_v4_100"),
            "verdict": shadow.get("v4_verdict"),
            "module": shadow.get("v4_module"),
            "confidence": shadow.get("v4_confidence"),
