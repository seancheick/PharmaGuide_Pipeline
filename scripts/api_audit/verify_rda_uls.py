...
DRI_REFERENCE = {
    ...
    "Folate": {
        ...
        "groups": {
            ...
            ("Male", "51-70"): (400, 1000),
            ("Male", "71+"): (400, 1000),
            ("Female", "14-18"): (400, 800),
            ("Female", "19-30"): (400, 1000),
            ("Female", "31-50"): (400, 1000),
            ("Female", "51-70"): (400, 1000),
            ("Female", "71+"): (400, 1000),
            ("Pregnancy", "14-18"): (600, 800),
            ("Pregnancy", "19-30"): (600, 1000),
            ("Pregnancy", "31-50"): (600, 1000),
            ("Lactation", "14-18"): (500, 800),
            ("Lactation", "19-30"): (500, 1000),
            ("Lactation", "31-50"): (500, 1000),
        },
    },
    "Vitamin B12": {
        "unit": "mcg",
