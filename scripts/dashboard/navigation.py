...
PAGE_DEFINITIONS = [
    ...
    ("Quality", "Scoring Integrity", "scoring-integrity"),
    ("Quality", "Pillar Audit", "pillar-audit"),
    ("Quality", "Module Health", "module-health"),
    ("Quality", "Suppression Audit", "suppression-audit"),
